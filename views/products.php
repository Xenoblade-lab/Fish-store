        ...
        <div class="container">
            <div class="header-content">
                ...
                <nav class="nav">
                    ...
                    <a href="products.html" class="nav-link active">Produits</a>
    ...
    <main class="main">
        <div class="container">
            ...
            <div class="filters">
                ...
                <button class="filter-btn" data-category="poisson">Poissons</button>
                <button class="filter-btn" data-category="crustaces">Crustacés</button>
                <button class="filter-btn" data-category="coquillages">Coquillages</button>
            </div>
